...
public class MovieRecommenderSystemApplication5 {
	...
	public static void main(String[] args) {
		...
		ApplicationContext appContext = SpringApplication.run(
				MovieRecommenderSystemApplication5.class, args);

		// use app context getBean() of class RecommenderImplementation4
		RecommenderImplementation5 recommender = appContext.getBean(
				RecommenderImplementation5.class);
